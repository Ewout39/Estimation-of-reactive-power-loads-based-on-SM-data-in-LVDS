...
network consumers using smart meter data", by Ewout Venstermans, Md. Umar Hashmi, and Marta Vanin. The code is run using a local environment on Python 3.12.4 and with Julia 1.12.6
